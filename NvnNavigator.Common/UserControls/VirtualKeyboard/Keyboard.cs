    ...
    public partial class KeyboardControl : UserControl {
        ...
        public BoW KeyboardType {
            ...
            set {
                ...
                if (pvtKeyboardType == BoW.Standard) {
                    pictureBoxKeyboard.Image = Properties.Resources.keyboard_white;
                    pictureBoxCapsLockDown.Image = Properties.Resources.caps_down_white;
                    pictureBoxLeftShiftDown.Image = Properties.Resources.shift_down_white;
                    pictureBoxRightShiftDown.Image = Properties.Resources.shift_down_white;
                } else if (pvtKeyboardType == BoW.Alphabetical) {
                    pictureBoxKeyboard.Image = Properties.Resources.keyboard_alphabetical;
                    pictureBoxCapsLockDown.Image = Properties.Resources.caps_down_white;
                    pictureBoxLeftShiftDown.Image = Properties.Resources.shift_down_white;
                    pictureBoxRightShiftDown.Image = Properties.Resources.shift_down_white;
                } else   //   kids keyboard
                {
                    pictureBoxKeyboard.Image = Properties.Resources.keyboard_kids_lower;
                }
            }
        }
        ...
        private void HandleCapsLock() {
            if (capslockindicator) {
                ...
                if (pvtKeyboardType == BoW.Kids) pictureBoxKeyboard.Image = Properties.Resources.keyboard_kids_lower;
            } else {
                capslockindicator = true;
                if (pvtKeyboardType == BoW.Kids) pictureBoxKeyboard.Image = Properties.Resources.keyboard_kids_upper;
